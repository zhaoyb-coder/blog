        ...
        try {
            ...
            routeHandle.route("/all", new HttpServerHandler() {
                ...
                public void handle(HttpRequest request, HttpResponse response) throws IOException {
                    ...
                    response.write(mapper.writeValueAsBytes(msg));
                }
            });
            // 3. 启动服务
...
客户端使用Swing构建一个操作界面，可以根据点击事件进行服务器的通信，Swing使用了开源的**[beautyeye](https://gitee.com/jackjiang/beautyeye)**进行美化。
...
![image-20240120153812623](https://raw.githubusercontent.com/zhaoyb-coder/pic-repo/main/image-20240120153812623.png)

![image-20240120153843471](https://raw.githubusercontent.com/zhaoyb-coder/pic-repo/main/image-20240120153843471.png)